...
class Users 
{
    ...
    array(
        ...
        /*\DB::query("INSERT INTO Users(id, userName, email, password, id_role, id_device, profilePicture, x, y)VALUES(NULL,'Admin','admin','5/5/1996','admin@cev.com', 'admin','asdafr','1','0','0','0');")->execute();*/ 
    }
